...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: `fixed w-full z-50 transition-all duration-300 ${scrolled ? "glass-nav py-3" : "bg-transparent py-5"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#home", className: "text-xl md:text-2xl font-serif font-bold text-dark-900 tracking-wide hover:text-accent transition-colors", children: "臺灣禛好文化學院" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex space-x-10", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: link.href,
          ...
          children: [
            link.name,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1.5 left-0 w-0 h-0.5 bg-accent transition-all duration-300 group-hover:w-full" })
          ]
        },
        link.name
      )) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-3 pb-4 space-y-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative h-screen flex flex-col items-center justify-center overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 z-0 bg-cover bg-center bg-no-repeat",
        style: {
          backgroundImage: `url(${"/college/"}hero-bg-vibrant.png)`
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-surface-primary/40 via-surface-primary/20 to-surface-primary/50" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 mt-16 md:mt-0 flex flex-col items-center w-full max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-accent shadow-glow animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-editorial italic pr-2 text-accent font-semibold text-lg", children: "The Life System" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-px h-4 bg-primary-300 mx-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark-700 tracking-[0.2em] text-sm md:text-base font-medium uppercase", children: "生命能量覺醒領航師" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-accent shadow-glow animate-pulse" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            "李虹禛 ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl sm:text-4xl md:text-6xl text-accent font-medium -ml-1 md:-ml-2", children: "老師" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          className: "w-full",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-[1.5px] bg-gradient-to-r from-transparent via-accent/60 to-transparent rounded-2xl mx-auto max-w-3xl w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface-primary/75 backdrop-blur-md rounded-2xl py-5 px-5 md:py-7 md:px-10 shadow-card border border-primary-200/50 relative overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 -left-full w-1/2 h-full bg-gradient-to-r from-transparent via-white/30 to-transparent skew-x-[-20deg] animate-[shine_6s_ease-in-out_infinite] will-change-transform" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "tracking-[0.1em] md:tracking-[0.2em] text-dark-600 font-medium mb-3 uppercase text-xs md:text-sm relative z-10 w-full flex items-center justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-editorial text-accent italic text-base mr-2", children: "est." }),
              " 臺灣禛好文化學院 ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-editorial text-accent italic text-base ml-2", children: "Founder" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-dark-900 font-bold text-lg md:text-2xl leading-relaxed relative z-10", children: [
              "「將易經 × 數字能量 × 心靈療癒",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "block md:hidden" }),
              "整合為一套可落地的生命系統」"
            ] })
          ] }) })
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#about", className: "group relative px-8 py-4 bg-dark-900 text-white rounded-full font-bold tracking-widest text-lg overflow-hidden flex items-center shadow-card hover:shadow-card-hover transition-all duration-300 transform hover:-translate-y-1 cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 w-full h-full bg-gradient-to-r from-accent via-accent-dark to-accent opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "預約生命導航諮詢" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-5 h-5 ml-3 transform group-hover:translate-x-1 transition-transform", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M17 8l4 4m0 0l-4 4m4-4H3" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#academy", className: "px-8 py-4 text-dark-700 font-bold tracking-widest hover:text-accent transition-colors flex items-center group cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "探索能量系統" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0 h-0.5 bg-accent ml-2 group-hover:w-6 transition-all duration-300" })
            ] })
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-dark-600 tracking-[0.3em] font-medium mb-3 uppercase opacity-70", children: "探索更多" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              animate: { y: [0, 10, 0] },
              transition: { repeat: Infinity, duration: 2, ease: "easeInOut" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#about", className: "flex items-center justify-center w-11 h-11 rounded-full bg-surface-primary/70 border border-primary-200 text-accent hover:bg-surface-primary hover:shadow-soft transition-all duration-300 cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 24, strokeWidth: 2 }) })
            }
          )
        ]
      }
...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "about", ref: sectionRef, className: "py-24 md:py-32 relative overflow-hidden bg-surface-secondary", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 -left-32 w-80 h-80 bg-muted-sand/50 rounded-full blur-3xl pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 right-0 w-96 h-96 bg-muted-rose/30 rounded-full blur-3xl pointer-events-none transform translate-x-1/3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-20 left-1/4 w-80 h-80 bg-muted-lavender/30 rounded-full blur-3xl pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 mb-32 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md aspect-[4/5] rounded-[2rem]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: `${"/college/"}author-profile.jpg`,
                      alt: "李虹禛老師",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full border border-dashed border-accent/50 flex items-center justify-center bg-surface-warm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-7 h-7 text-accent" }) })
                }
              )
            ] })
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center justify-center lg:justify-start space-x-2 mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-px bg-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent tracking-[0.3em] text-xs font-semibold uppercase", children: "About the Founder" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-serif font-black text-dark-900 mb-4 md:mb-5 leading-tight", children: [
                "李虹禛 ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl sm:text-3xl text-dark-600 font-medium", children: "老師" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg sm:text-xl md:text-2xl text-accent font-bold mb-6 md:mb-8 tracking-wide", children: "生命能量覺醒領航師" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 text-lg text-dark-700 leading-relaxed font-light mb-10 max-w-2xl mx-auto lg:mx-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  "身為",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-dark-900 font-semibold mx-1", children: "臺灣禛好文化學院" }),
                  "創辦人暨心靈易經研究者，李虹禛老師致力於將深奧的古典智慧，轉化為現代人能夠輕鬆理解並應用的生活法則。"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "bg-surface-primary/80 p-5 rounded-xl border-l-4 border-accent italic text-dark-800 shadow-soft", children: "「將易經 × 數字能量 × 心靈療癒，整合為一套可落地的生命系統，引導每個人找回內在平靜，喚醒靈魂深處的潛能。」" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center text-xs font-semibold text-dark-700 tracking-widest uppercase pb-1 border-b-2 border-accent/60", children: "Scroll for detailed resume" }) })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center mb-24 opacity-40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-px bg-gradient-to-r from-transparent via-dark-700 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-5 h-5 text-accent mx-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-px bg-gradient-to-r from-dark-700 via-dark-700 to-transparent" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: qualifications.map((group, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 md:w-10 md:h-10 rounded-lg bg-gradient-to-br from-accent-light to-accent flex items-center justify-center shadow-sm mr-4 border border-accent/20 transform group-hover:rotate-6 transition-transform duration-300 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-serif font-bold text-base md:text-lg", children: index + 1 }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl sm:text-2xl md:text-2xl font-serif font-bold text-dark-900 tracking-wide", children: group.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: group.items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start group/item", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 mr-3.5 flex-shrink-0 w-2 h-2 rounded-full bg-accent/60 group-hover/item:bg-accent transition-colors" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark-700 font-medium text-base sm:text-lg leading-relaxed group-hover/item:text-dark-900 transition-colors", children: item })
                ] }, i)) })
              ] })
            },
            index
...
const pillars = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-10 h-10 text-white", strokeWidth: 1.5 }),
    color: "from-accent-light to-accent-dark",
    title: "易經哲學",
    description: "傳承千年智慧，剖析宇宙萬物運行的規律，引導我們順應自然，趨吉避凶。"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-10 h-10 text-white", strokeWidth: 1.5 }),
    color: "from-primary-500 to-primary-700",
    title: "數字能量",
    description: "解析生命靈數與周遭數字磁場，揭示潛藏的天賦與人生軌跡，掌握命運的鑰匙。"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-10 h-10 text-white", strokeWidth: 1.5 }),
...
function AcademySection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "academy", className: "py-28 md:py-36 relative overflow-hidden bg-surface-primary", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-[0.02]", style: { backgroundImage: "radial-gradient(#1C1917 1px, transparent 1px)", backgroundSize: "32px 32px" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-4xl mx-auto mb-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl sm:text-5xl md:text-6xl font-serif font-black text-dark-900 mb-6 md:mb-8 leading-tight", children: "臺灣禛好文化學院" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.p,
          {
            ...
            children: [
              "本學院致力於將深奧的東方智慧與現代心理學結合，為現代人提供一套",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-accent relative mx-1", children: [
                "可落地的生命系統",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-0 w-full h-[2px] bg-accent/30 rounded" })
              ] })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10", children: pillars.map((pillar, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 40 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 bg-gradient-to-b ${pillar.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl -z-10` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-20 h-20 mb-8 rounded-2xl bg-gradient-to-br ${pillar.color} flex items-center justify-center shadow-sm group-hover:scale-110 group-hover:shadow-glow transition-all duration-300`, children: pillar.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl md:text-2xl font-bold tracking-wide text-dark-900 mb-4 group-hover:text-white transition-colors duration-300", children: pillar.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base md:text-lg text-dark-600 leading-relaxed text-center group-hover:text-white/90 transition-colors duration-300", children: pillar.description })
          ]
        },
        index
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-dark-900 via-dark-800 to-dark-900" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-96 h-96 bg-accent/10 rounded-full blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-8 sm:p-12 md:p-16 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-surface-primary mb-5 md:mb-6 leading-tight", children: "喚醒生命能量，找回最真實的自己" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg sm:text-xl text-primary-300 max-w-3xl mx-auto leading-relaxed md:leading-loose font-light", children: [
                "透過這套獨步全球的生命系統，李虹禛老師將與您一起",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
...
function WorksGallery() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "works", className: "py-24 md:py-32 relative overflow-hidden bg-dark-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-dark-900 border-t border-primary-900/30 text-primary-300 py-16 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-accent/40 to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-12 lg:col-span-5 pr-0 lg:pr-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-2xl font-serif text-surface-primary font-bold mb-5 flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-px bg-accent mr-3 hidden sm:block" }),
            "臺灣禛好",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-editorial italic font-normal text-accent-light px-1", children: "Culture" }),
            "學院"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base leading-relaxed text-primary-400 text-justify font-light", children: "結合易經、數字能量與心靈療癒，為生命能量覺醒導航。我們致力於打造一套可落地的生命系統，幫助每一個靈魂找到平衡與平靜。" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-6 lg:col-span-3 lg:col-start-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold mb-5 tracking-[0.2em] uppercase text-accent-muted font-display", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3.5 font-light", children: [
            { name: "關於老師", href: "#about" },
            { name: "學院理念", href: "#academy" },
            { name: "著作與成果", href: "#works" }
          ].map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: link.href, className: "text-primary-400 hover:text-surface-primary transition-colors duration-200 flex items-center group cursor-pointer", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-0 h-px bg-accent mr-0 group-hover:w-3 group-hover:mr-2 transition-all duration-300" }),
            link.name
          ] }) }, link.name)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-6 lg:col-span-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold mb-5 tracking-[0.2em] uppercase text-accent-muted font-display", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4 font-light text-primary-400", children: [
            { icon: Mail, text: "contact@example.com", note: "(示意)" },
            { icon: Phone, text: "+886 2 2345 6789", note: "(示意)" },
            { icon: MapPin, text: "台北市信義區信義路五段", note: "(示意)" }
          ].map(({ icon: Icon, text, note }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start group cursor-pointer hover:text-surface-primary transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1.5 rounded-lg bg-dark-800 border border-primary-900/40 group-hover:border-accent/40 group-hover:bg-accent/10 mr-3 transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3.5 h-3.5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-0.5 text-sm", children: [
              text,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-40 block", children: note })
            ] })
          ] }, i)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 pt-6 border-t border-primary-900/30 flex flex-col md:flex-row justify-between items-center text-xs text-primary-500 font-light font-display", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " 臺灣禛好文化學院. All rights reserved."
      ] }) })
    ] })
  ] });
}
